...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide z-3" data-bs-ride="carousel">
      ...
      <div class="flex flex-wrap -m-4">
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="img/organic waste.jpg"
              alt="content" />
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="img/recyclable waste.jpg"
              alt="content" />
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="img/hazardous waste.png"
              alt="content" />
        ...
        <div class="xl:w-1/4 md:w-1/2 p-4">
          <div class="bg-gray-100 p-6 rounded-lg">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="img/electronic waste.jpg"
              alt="content" />
  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 sm:w-1/3 w-full rounded-lg overflow-hidden mt-6 sm:mt-0">
        <img class="object-cover object-center w-full h-full" src="img/manage.png" alt="stats" />
      </div>
    </div>
  </section>
  <!-- *************************  FLOW CHART PROCESS OF WASTE MANAGEMENT STARTS *************************************-->
        ...
        <div class="p-4 lg:w-1/2">
          <div
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <p class="mb-4">
                When waste is not managed properly, it can contaminate soil, water and air, leading to pollution and
                harming ecosystem.
              </p>
            </div>
          </div>
        ...
        <div class="p-4 lg:w-1/2">
          <div
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <p class="mb-4">
                Improper disposal of hazardous waste can pose health risks to human and animal. Exposure to toxic
                substances can cause illnesses and diseases..
              </p>
        ...
        <div class="p-4 lg:w-1/2">
          <div
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <p class="mb-4">
                When waste is not recycled or reused, valuable resources are wasted. This puts a strain on natural
                resources and contributes to resource depletion.
              </p>
        ...
        <div class="p-4 lg:w-1/2">
          <div
            ...
            <div class="flex-grow sm:pl-8">
              ...
              <p class="mb-4">
                Landfills and incineration of waste release greenhouse gases, contributing to climate change and global
                warming.
              </p>
            </div>
          </div>
    ...
    <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
      <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
        ...
        <p class="leading-relaxed text-base">A new wave of leaders had arrived, and they are *Trash Master*.
          ...
          sustainability & environmental awareness.</p>
